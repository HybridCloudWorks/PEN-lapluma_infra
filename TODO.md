...
| [INF-06: Complete I-series form and supplement coverage](https://github.com/orgs/HybridCloudWorks/projects/2) | P1 | Delivered full I-series coverage (91 forms and supplements) reconciled from authoritative USCIS manifest into Document Library with preparation capabilities (`FILLABLE_PDF`, `STATIC_ASSISTED`, `EXTERNAL_REFERENCE`), official edition dates, and core API integration. | INF-01; INF-04; INF-05 |
| [INF-07: Complete N-series form and supplement coverage](https://github.com/orgs/HybridCloudWorks/projects/2) | P1 | Delivered full N-series coverage (10 forms and supplements) covering naturalization/citizenship petitions, role-restricted portions, and core API integration. | INF-01; INF-04; INF-05 |
| [INF-08: Complete G-series, other series and external-form coverage](https://github.com/orgs/HybridCloudWorks/projects/2) | P1 | Delivered full G-series (14 forms), other series (2: AR-11, EOIR-29), and preserved non-USCIS definitions (`DS-11`, `FAFSA`, `CLINIC-INTAKE`, `SCHOLARSHIP-APP`) without service proliferation. | INF-01; INF-04; INF-05 |
| [INF-09: Version official and institutional document guidance](https://github.com/orgs/HybridCloudWorks/projects/2) | P1 | Delivered source-cited official document guidance contract schema (`contracts/schemas/document-guidance.schema.json`), authoritative guidance dataset (`contracts/uscis-official-guidance.json`) with 121 entries, zero fee guessing enforcement (citing Form G-1055 references or fixed statutory cents), official evidence checklists distinct from institutional guidance notes, core API endpoint (`/v1/library/blueprints/{namespace}/{blueprintId}/guidance`), and automated test suite. | INF-02; INF-03 |
